...
public class Base {
    ...
    static final Map<String,Object> link = new HashMap<String,Object>() {{
        put("rel", new HashMap<String,Object>() {{ put("type", String.class); put("required", true); }});
        put("type", new HashMap<String,Object>() {{ put("type", String.class); put("required", false); }});
        put("href", new HashMap<String,Object>() {{ put("type", String.class); put("required", false); }});
        put("titles", new HashMap<String,Object>() {{ put("type", Map.class); put("required", false); }});
