...
public class CheckID extends Service {
    ...
    private static String request = "checkId";

    public CheckID(String httpLib, KeyJar keyJar, String clientAuthenticationMethod, Map<String,String> conf) throws NoSuchFieldException, IllegalAccessException {
        super(httpLib, keyJar, clientAuthenticationMethod, conf);
        this.preConstruct = Arrays.asList(this.oicPreConstruct);
    }
